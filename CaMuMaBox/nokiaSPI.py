...
class NokiaSPI:
    ...
    def display_largechar(self, char, character_position, display_on_row, font=LARGEFONT):
      try:
        self.gotorc(0 + display_on_row, character_position)
        for value in font[char][0]:
          self.lcd_data(value)
        self.gotorc(1 + display_on_row, character_position)
        for value in font[char][1]:
          self.lcd_data(value)
        self.gotorc(2 + display_on_row, character_position)
    ...
    def largetext(self,string, display_on_row, font=LARGEFONT):
      character_position = 0
      for char in string:
        self.display_largechar(char, character_position, display_on_row, font)
